...
templates['bookmarks.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"list-group-item list-group-item-primary\">"
    ...
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(data && lookupProperty(data,"last")),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.program(6, data, 0),"data":data,"loc":{"start":{"line":13,"column":0},"end":{"line":13,"column":77}}})) != null ? stack1 : "")
    + "\n";
  ...
  return "  <a href=\""
    ...
    + alias2(((helper = (helper = lookupProperty(helpers,"API_BASE") || (depth0 != null ? lookupProperty(depth0,"API_BASE") : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"API_BASE","hash":{},"data":data,"loc":{"start":{"line":6,"column":15},"end":{"line":6,"column":27}}}) : helper)))
    + "/bookmark/icon/"
    + alias2((lookupProperty(helpers,"domainonly")||(depth0 && lookupProperty(depth0,"domainonly"))||alias4).call(alias3,(depth0 != null ? lookupProperty(depth0,"href") : depth0),{"name":"domainonly","hash":{},"data":data,"loc":{"start":{"line":6,"column":42},"end":{"line":6,"column":66}}}))
    + "\" style=\"max-width:32px;max-height:32px;\" />\n    <span>\n      "
    + alias2(((helper = (helper = lookupProperty(helpers,"key") || (data && lookupProperty(data,"key"))) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"key","hash":{},"data":data,"loc":{"start":{"line":8,"column":6},"end":{"line":8,"column":14}}}) : helper)))
  ...
  return "<div class=\"list-group\" style=\"max-width:370px\">\n"
...
templates['iconlist.hbs'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "  <a href=\""
    ...
    + "\" style=\"max-width:32px;ma-height:32px;\" />\n    <span>\n      "
